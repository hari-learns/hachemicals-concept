...
<section class="bg-navy"><div class="wrap">
    <div class="section-head"><div><div class="eyebrow on-dark" data-reveal>Industry Achievements</div><h2 data-reveal="wipe">Quality, affordable, manufacturing and industrial services</h2></div></div>
    <div class="counter-row"><?php foreach ( $counters as $index => $counter ) : ?><div data-reveal style="--i:<?php echo esc_attr( $index ); ?>"><b data-count="<?php echo esc_attr( $counter['value'] ); ?>">0</b><span><?php echo esc_html( $counter['label'] ); ?></span></div><?php endforeach; ?></div>
</div></section>
